module.exports = {
    SYSTEM_ERROR: {code:0, msg:"系统错误"},
    PRIVATE_MSG: {code:1, msg:"有新私聊信息"},
    GROUP_MSG: {code:2, msg:"有新群组信息"},
    NEW_APPLY: {code:3, msg:"收到新的申请"},
    NEW_FRIEND: {code:4, msg:"您的好友申请已通过"},
    ...
    BE_OWNER: {code: 12, msg: '成为群主'},
    BANNED: {code: 999, msg: '账号被封禁'}
}